                ...
                <form className="filters">
                    ...
                    <fieldset>
                        <div className="toggle-view">
                            <p> <input type='radio' name='createdBy' value='' onChange={handleControlledInputChange} /> All Tasks</p>
                            <p> <input type='radio' name='createdBy' value='tr' onChange={handleControlledInputChange} /> My Tasks Only </p>
                    ...
                    <div className="add-task">
                        <button onClick={() => {
                            history.push({ pathname: `/tasks/form` })
                                ...
                                return <Card key={task.id} style={{ width: '18rem', margin: '2rem' }}>
                                    ...
                                    <Card.Body key={task.id}>
                                        ...
                                        {task.is_universal ? " " : <button onClick={() => {
                                            history.push({ pathname: `/tasks/edit/${task.id}` })
                                        }}>Edit</button>}
                                        {task.is_universal ? "" : <button onClick={() =>
                                            deleteTask(task.id)
